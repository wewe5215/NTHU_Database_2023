...
public class TransactionMgr implements TransactionLifecycleListener {
	...
	//109062320 add ConservativeConcurrencyMgrCycleListeners
	public static Class<?> conserveConcurMgrCls, serialConcurMgrCls, rrConcurMgrCls, rcConcurMgrCls, recoveryMgrCls, bufferMgrCls;
	static {
		//109062320 add
		conserveConcurMgrCls = CoreProperties.getLoader().getPropertyAsClass(
