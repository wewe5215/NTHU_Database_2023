...
public class Parser {
	...
	public QueryData queryCommand() {
		// 109062143 chack if there is explain, simaliat to where
		boolean explain_flag = false;
		...
		// 109062143 add return explain flag
		return new QueryData(projs.asStringSet(), tables, pred,
				groupFields, projs.aggregationFns(), sortFields, sortDirs,explain_flag);
	}
