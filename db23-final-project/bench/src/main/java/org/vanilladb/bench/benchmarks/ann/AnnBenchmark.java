...
public class AnnBenchmark extends Benchmark {
    ...
    public void executeLoadingProcedure(SutConnection conn) throws SQLException {
        // 109062233 this will not be call upon benching
    ...
    @Override
    public boolean executeDatabaseCheckProcedure(SutConnection conn) throws SQLException { // 109062233 this will be call upon benching
