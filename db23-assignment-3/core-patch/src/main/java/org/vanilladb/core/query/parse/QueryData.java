...
public class QueryData {
	...
	// 109062143 add flag for if there is explain
	 ...
	 * 109062143 add -> mabe not need?
	 * @param explainFlag
	 * 			  if we need to explain the quary
	 */
	public QueryData(Set<String> projFields, Set<String> tables, Predicate pred,
			Set<String> groupFields, Set<AggregationFn> aggFn, List<String> sortFields, List<Integer> sortDirs, boolean explainFlag) {
	...
	/**
	 * Returns the explainFlag mentioned in the clause.
	 * 
	 * @return there is a explain mode
	 */
	...
	public String toString() {
		...
		// 109062143 add the explain in the beginning
		if (explainFlag)
