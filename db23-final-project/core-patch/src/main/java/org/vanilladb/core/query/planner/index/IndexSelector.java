...
public class IndexSelector {
	...
	// 109062233 [add shortcut]
	/*public static IndexInfo get_index_info(String fieldName , String tblName , Transaction tx) {
		List<IndexInfo> iis = VanillaDb.catalogMgr().getIndexInfo(tblName, fieldName, tx);
		System.out.println("field name : " + fieldName + " tbl name : " + tblName);
