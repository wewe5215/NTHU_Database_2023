...
class TablePlanner {
	...
	public TablePlanner(String tblName, Predicate pred, List<DistanceFn> embFields, Transaction tx, int id) { // 109062233 [to be mod]
		this.tblName = tblName;
		this.pred = pred;
		this.tx = tx;
		this.id = id;
		...
		for (DistanceFn embField : embFields) {
			// 109062233 [debug]
			// System.out.println("TablePlanner: " + embField.fieldName());
			// Output : TablePlanner: i_emb
